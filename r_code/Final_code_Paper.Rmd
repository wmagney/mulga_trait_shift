...
```{r}
final.basal.fit <- lmer(log(basal_area) ~ rainfall + (1|plots/subplot) , data = f.D2H_model, control = lmerControl(optimizer ="Nelder_Mead"), REML = T) 
